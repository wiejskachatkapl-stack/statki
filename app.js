(() => {
  const STATKI_BUILD_VERSION = 'v1032';
  console.log('STATKI build', STATKI_BUILD_VERSION, 'STATKI_CACHE_RESET_V1032');
  ...
  setInterval(() => {
  const STATKI_BUILD_VERSION = 'v1032';
  console.log('STATKI build', STATKI_BUILD_VERSION, 'STATKI_CACHE_RESET_V1032'); if (!gameScreen.classList.contains('hidden')) { registerPlayer(); processEvents(); renderPlayers(); } }, HEARTBEAT_MS);
